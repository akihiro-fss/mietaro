...
class Controller_Electric_monthDemand extends Controller
{
  ...
  public function action_index()
  {
     ...
     $theme->get_template()->set('content', $theme->view('electric/monthdemand', $monthdata)->set('monthData',$monthdata));
