...
class Controller_Electric_monthinfo extends Controller {
    ...
    public function action_index() {
        //日付フォームの値を取得
        $param = \Input::post();
        $onemonthDate = \Arr::get($param,'param_date_1',null);
        ...
        //使用電力詳細情報を取得
        $result = \Model_ElectricInfo::getMonthData($strId,$onemonthDate);
        ...
        $theme->get_template()->set('content', $theme->view('electric/monthinfo')->set('electricData',$result));
        //テーマのテンプレートにビューとページデータをセット
