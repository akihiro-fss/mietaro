...
class Controller_Electric_yearinfo extends Controller {
    ...
    public function action_index() {
        ...
        //使用電力詳細情報を取得
        $result = \Model_ElectricInfo::getYearData($strId,$oneyearDate, $twoyearDate);
        ...
        $theme->get_template()->set('content', $theme->view('electric/yearinfo')->set('electricData',$result));
        //テーマのテンプレートにビューとページデータをセット
