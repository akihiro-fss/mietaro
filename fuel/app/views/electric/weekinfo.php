...
//電力量テーブル作成
    ...
    $.each(oneweekData, function (key, value) {
        $('#electric-data-table-1').append('<tr><td style="width:50px;">' + key + '</td><td>' + value['total'] + '</td><td>' + value['demand_kw'] + '</td><td>' + value['electric_at'] + '</td><td>' + value['temperature'] + '</td><td>' + value['humidity'] + '</td></tr>');
    });

    $.each(twoweekData, function (key, value) {
        $('#electric-data-table-2').append('<tr><td style="width:50px;">' + key + '</td><td>' + value['total'] + '</td><td>' + value['demand_kw'] + '</td><td>' + value['electric_at'] + '</td><td>' + value['temperature'] + '</td><td>' + value['humidity'] + '</td></tr>');
    });
