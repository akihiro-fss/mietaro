...
class Auth_Login_Simpleauth extends \Auth_Login_Driver {
     ...
     * @return  bool
     */
    public function create_user($username, $password, $email, $group = 1,$ep_id, $str_id, Array $profile_fields = array()) {
    ...
    /**
     * Get the user's str_id
     *
     * @return  string
     */
    public function get_ep_id() {
        return $this->get('ep_id', false);
    }
